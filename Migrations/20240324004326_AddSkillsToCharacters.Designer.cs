...
namespace dotnetRpgApi.Migrations
{
    ...
    [Migration("20240324004326_AddSkillsToCharacters")]
    partial class AddSkillsToCharacters
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotnetRpgApi.Models.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CharacterSkill", b =>
                {
                    b.HasOne("dotnetRpgApi.Models.Character", null)
                        .WithMany()
                        .HasForeignKey("CharactersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("dotnetRpgApi.Models.Skill", null)
                        .WithMany()
